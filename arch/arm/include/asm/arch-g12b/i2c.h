...
#define MESON_I2C_MASTER_B_GPIOH_6_REG		(PERIPHS_PIN_MUX_B)
#define MESON_I2C_MASTER_B_GPIOH_6_BIT		(4<<24)
#define MESON_I2C_MASTER_B_GPIOH_7_REG		(PERIPHS_PIN_MUX_B)
#define MESON_I2C_MASTER_B_GPIOH_7_BIT		(4<<28)
